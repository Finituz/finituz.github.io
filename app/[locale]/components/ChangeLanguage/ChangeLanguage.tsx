...
export default function ChangeLanguage() {
  ...
  return (
    <div className="group fixed flex flex-col items-center gap-2 right-2 top-52 z-20">
      <i
        id="currentLanguage"
      ...
      <ul className="hidden bg-red-900 border  gap-2 rounded-xl group-hover:flex flex-col p-5 mr-28">
